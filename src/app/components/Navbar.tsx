  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
      <img
        ...
        alt="Company Logo"
        style={{ height: '60px', width: '60px', marginTop: '10px', cursor: 'pointer' }}
      />
      <Typography variant="h6" sx={{ my: 2 }}>
        Deal Magsil
        <br/>
      <Typography  sx={{ my: 2,fontSize:'15px', color:'red',marginTop:'-5px' }}>
Since 1991
     </Typography>
      </Typography>
      <Divider />
          ...
          <Link href="/" passHref>
            <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
              <img
                src="http://nebula.wsimg.com/f6f02f85f065096f57161ffd21c2a893?AccessKeyId=EE46D1080F0D18C989B0&disposition=0&alloworigin=1"
                alt="Company Logo"
                style={{ height: '60px', width: '60px', marginRight: '10px', cursor: 'pointer' }}
              />
            </Box>
          </Link>
